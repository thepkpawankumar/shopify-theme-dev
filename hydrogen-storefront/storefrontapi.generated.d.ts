...
> & {
  size_chart?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  options: Array<
...
export type GetColorGroupsQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type GetColorGroupsQuery = {
  metaobjects: {
    edges: Array<{
...
export type GetPageDetailsQueryVariables = StorefrontAPI.Exact<{
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query GetColorGroups {\n  metaobjects(type: "product_color_groups", first: 100) {\n    edges {\n      node {\n        handle\n        fields {\n          key\n          value\n        }\n      }\n    }\n  }\n}': {
    return: GetColorGroupsQuery;
    variables: GetColorGroupsQueryVariables;
  };
